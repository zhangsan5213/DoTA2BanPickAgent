...
class TrainingConfig:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        if config_path is None:
            config_path = Path(__file__).parent.parent / "configs" / "bp_agent_config.yaml"
        ...
        self.historical_opponent_prob = training_cfg.get("historical_opponent_prob", 0.6)
        ...
        # Oracle config
        self.oracle_path = cfg.get("oracle_path", "./ckpts/win_rate_oracle-num_heroes_160-text-embd_dim_128-player_attention/win_rate_oracle-20260309033516-000-0.9042.pth")
